...
export const templateMsgSchedular = async () => {
  setInterval(async () => {
    ...
    for (let i = 0; i < users.length; i++) {
      ...
      if (user && user.createdAt) {
        ...
        if (
          tsDifference >= 8 * 60 * 60 * 1000 &&
          tsDifference <= 9 * 60 * 60 * 1000
        )
          sendTemplateFlag = true;
        else if (
          tsDifference >= 16 * 60 * 60 * 1000 &&
          tsDifference <= 17 * 60 * 60 * 1000
        )
          sendTemplateFlag = true;
        if (
          tsDifference >= 32 * 60 * 60 * 1000 &&
          tsDifference <= 33 * 60 * 60 * 1000
        )
          sendTemplateFlag = true;
        if (
          tsDifference >= 48 * 60 * 60 * 1000 &&
          tsDifference <= 49 * 60 * 60 * 1000
        )
          sendTemplateFlag = true;
        if (
          tsDifference >= 72 * 60 * 60 * 1000 &&
          tsDifference <= 73 * 60 * 60 * 1000
        )
          sendTemplateFlag = true;
        if (
          tsDifference >= 96 * 60 * 60 * 1000 &&
